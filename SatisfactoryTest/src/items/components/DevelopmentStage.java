...
public class DevelopmentStage extends Items_Components{
	public DevelopmentStage(JSONArray _development)
	{
		itemDef = new ItemDefinition[_development.size()];
		for(int i = 0; i < _development.size(); i++)
		{
			JSONObject selected = (JSONObject)_development.get(i);
